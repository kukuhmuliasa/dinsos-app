        ...
        <div class="flex flex-col items-center gap-16">
            ...
            <div class="group bg-white rounded-[3rem] shadow-[0_35px_80px_-15px_rgba(0,0,0,0.3)] border border-gray-200 overflow-hidden flex flex-col w-full transition-transform duration-500 hover:-translate-y-2">
                ...
                <div class="relative h-[850px] bg-gray-300 w-full">
                    <iframe 
                        src="{{ route('secure.file', $doc->file) }}#view=FitH&toolbar=0" 
                        class="w-full h-full" 
                        frameborder="0">
                    </iframe>
                    ...
                    <div class="absolute top-8 right-8">
                        <a href="{{ route('secure.file', $doc->file) }}" target="_blank" class="bg-white/95 backdrop-blur-md px-6 py-3 rounded-2xl shadow-2xl text-red-700 hover:bg-red-700 hover:text-white transition-all flex items-center gap-3 font-black text-sm uppercase tracking-widest border border-red-100">
                ...
                <div class="p-12 text-center bg-white">
                    ...
                    <p class="text-gray-500 font-bold mb-10 flex justify-center items-center gap-2 uppercase tracking-widest text-xs">
                        ...
                        Arsip Resmi: {{ ($doc->published_at ?? $doc->created_at)->translatedFormat('d F Y') }}
                        <span class="w-8 h-[2px] bg-red-600"></span>
                    </p>
                    
                    <div class="flex flex-col md:flex-row gap-4 justify-center">
                        <a href="{{ route('secure.file', $doc->file) }}" download class="inline-flex items-center justify-center px-10 py-5 bg-red-700 text-white font-black rounded-2xl hover:bg-gray-900 transition-all duration-300 shadow-xl text-lg group-hover:shadow-red-900/40">
